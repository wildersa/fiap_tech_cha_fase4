...
def run_training_pipeline(cfg: TrainConfig, csv_path: str | None = None) -> dict:
    ...
    mlflow.start_run(run_name=f"{cfg.symbol}_{cfg.feature_mode}_{cfg.target_mode}")
    ...
    if cfg.feature_mode == "single":
        ...
        feature_cols = ["Log_Return", "SMA_7", "SMA_21", "Volatility_21", "Momentum_5", "Range_Pct", "Volume_Z"]
    else:
